...
class WebAppOpenMode extends TdObject {
  ...
  WebAppOpenMode copyWith() => const WebAppOpenMode();
...
class WebAppOpenModeCompact extends WebAppOpenMode {
  ...
  /// Parse from a json
  factory WebAppOpenModeCompact.fromJson(Map<String, dynamic> json) => const WebAppOpenModeCompact();
...
class WebAppOpenModeFullSize extends WebAppOpenMode {
  ...
  /// Parse from a json
  factory WebAppOpenModeFullSize.fromJson(Map<String, dynamic> json) => const WebAppOpenModeFullSize();
...
class WebAppOpenModeFullScreen extends WebAppOpenMode {
  ...
  /// Parse from a json
  factory WebAppOpenModeFullScreen.fromJson(Map<String, dynamic> json) => const WebAppOpenModeFullScreen();
