...
class TextEntityTypeExpandableBlockQuote extends TextEntityType {
  ...
  /// Parse from a json
  factory TextEntityTypeExpandableBlockQuote.fromJson(Map<String, dynamic> json) => const TextEntityTypeExpandableBlockQuote();
  ...
  @override
  TextEntityTypeExpandableBlockQuote copyWith() => const TextEntityTypeExpandableBlockQuote();
