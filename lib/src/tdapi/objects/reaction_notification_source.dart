...
class ReactionNotificationSource extends TdObject {
  ...
  ReactionNotificationSource copyWith() => const ReactionNotificationSource();
...
class ReactionNotificationSourceNone extends ReactionNotificationSource {
  ...
  /// Parse from a json
  factory ReactionNotificationSourceNone.fromJson(Map<String, dynamic> json) => const ReactionNotificationSourceNone();
  ...
  @override
  ReactionNotificationSourceNone copyWith() => const ReactionNotificationSourceNone();
...
class ReactionNotificationSourceContacts extends ReactionNotificationSource {
  ...
  /// Parse from a json
  factory ReactionNotificationSourceContacts.fromJson(Map<String, dynamic> json) => const ReactionNotificationSourceContacts();
  ...
  @override
  ReactionNotificationSourceContacts copyWith() => const ReactionNotificationSourceContacts();
...
class ReactionNotificationSourceAll extends ReactionNotificationSource {
  ...
  /// Parse from a json
  factory ReactionNotificationSourceAll.fromJson(Map<String, dynamic> json) => const ReactionNotificationSourceAll();
  ...
  @override
  ReactionNotificationSourceAll copyWith() => const ReactionNotificationSourceAll();
