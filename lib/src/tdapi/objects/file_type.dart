...
class FileTypeSelfDestructingPhoto extends FileType {
  ...
  /// Parse from a json
  factory FileTypeSelfDestructingPhoto.fromJson(Map<String, dynamic> json) => const FileTypeSelfDestructingPhoto();
  ...
  @override
  FileTypeSelfDestructingPhoto copyWith() => const FileTypeSelfDestructingPhoto();
...
class FileTypeSelfDestructingVideo extends FileType {
  ...
  /// Parse from a json
  factory FileTypeSelfDestructingVideo.fromJson(Map<String, dynamic> json) => const FileTypeSelfDestructingVideo();
  ...
  @override
  FileTypeSelfDestructingVideo copyWith() => const FileTypeSelfDestructingVideo();
...
class FileTypeSelfDestructingVideoNote extends FileType {
  ...
  /// Parse from a json
  factory FileTypeSelfDestructingVideoNote.fromJson(Map<String, dynamic> json) => const FileTypeSelfDestructingVideoNote();
  ...
  @override
  FileTypeSelfDestructingVideoNote copyWith() => const FileTypeSelfDestructingVideoNote();
...
class FileTypeSelfDestructingVoiceNote extends FileType {
  ...
  /// Parse from a json
  factory FileTypeSelfDestructingVoiceNote.fromJson(Map<String, dynamic> json) => const FileTypeSelfDestructingVoiceNote();
  ...
  @override
  FileTypeSelfDestructingVoiceNote copyWith() => const FileTypeSelfDestructingVoiceNote();
