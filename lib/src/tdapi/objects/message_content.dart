...
class MessageVideo extends MessageContent {
  ...
  factory MessageVideo.fromJson(Map<String, dynamic> json) => MessageVideo(
        ...
        alternativeVideos: json['alternative_videos'] == null
            ? <AlternativeVideo>[]
            : (json['alternative_videos'] as List)
                .map((e) => AlternativeVideo.fromJson(e ?? {}))
                .toList(),
...
class MessageExpiredVideoNote extends MessageContent {
  ...
  @override
  MessageExpiredVideoNote copyWith() {
...
class MessageExpiredVoiceNote extends MessageContent {
  ...
  @override
  MessageExpiredVoiceNote copyWith() {
...
class MessageDice extends MessageContent {
  ...
  factory MessageDice.fromJson(Map<String, dynamic> json) => MessageDice(
        ...
        successAnimationFrameNumber:
            json['success_animation_frame_number'] ?? 0,
      );
  @override
  Map<String, dynamic> toJson([dynamic extra]) {
    return {
...
class MessageGroupCall extends MessageContent {
  ...
  factory MessageGroupCall.fromJson(Map<String, dynamic> json) =>
      MessageGroupCall(
        ...
        isVideo: json['is_video'] ?? false,
        duration: json['duration'] ?? 0,
        otherParticipantIds: json['other_participant_ids'] == null
            ? <MessageSender>[]
            : (json['other_participant_ids'] as List)
  ...
  Map<String, dynamic> toJson([dynamic extra]) {
    return {
      ...
      "other_participant_ids":
          otherParticipantIds.map((e) => e.toJson()).toList(),
    };
  }
...
class MessageChatDeletePhoto extends MessageContent {
  ...
  @override
  MessageChatDeletePhoto copyWith() {
...
class MessageChatJoinByLink extends MessageContent {
  ...
  @override
  MessageChatJoinByLink copyWith() {
...
class MessageChatJoinByRequest extends MessageContent {
  ...
  @override
  MessageChatJoinByRequest copyWith() {
...
class MessageScreenshotTaken extends MessageContent {
  ...
  @override
  MessageScreenshotTaken copyWith() {
...
class MessageGiveawayWinners extends MessageContent {
  ...
  factory MessageGiveawayWinners.fromJson(Map<String, dynamic> json) =>
      MessageGiveawayWinners(
        ...
        winnerCount: json['winner_count'] ?? 0,
        winnerUserIds: json['winner_user_ids'] == null
            ? <int>[]
            : (json['winner_user_ids'] as List)
                .map((e) => (e ?? 0) as int)
                .toList(),
        unclaimedPrizeCount: json['unclaimed_prize_count'] ?? 0,
      );
...
class MessageContactRegistered extends MessageContent {
  ...
  @override
  MessageContactRegistered copyWith() {
  ...
  factory MessagePassportDataSent.fromJson(Map<String, dynamic> json) =>
      MessagePassportDataSent(
        types: json['types'] == null
            ? <PassportElementType>[]
            : (json['types'] as List)
                .map((e) => PassportElementType.fromJson(e ?? {}))
                .toList(),
      );
  @override
  Map<String, dynamic> toJson([dynamic extra]) {
