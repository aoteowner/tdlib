...
class InputMessageForwarded extends InputMessageContent {
  ...
  InputMessageForwarded copyWith({
    ...
    replaceVideoStartTimestamp: replaceVideoStartTimestamp ?? this.replaceVideoStartTimestamp,
    newVideoStartTimestamp: newVideoStartTimestamp ?? this.newVideoStartTimestamp,
