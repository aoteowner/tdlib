...
class UserPrivacySettingShowBirthdate extends UserPrivacySetting {
  ...
  /// Parse from a json
  factory UserPrivacySettingShowBirthdate.fromJson(Map<String, dynamic> json) => const UserPrivacySettingShowBirthdate();
  ...
  @override
  UserPrivacySettingShowBirthdate copyWith() => const UserPrivacySettingShowBirthdate();
...
class UserPrivacySettingAutosaveGifts extends UserPrivacySetting {
  ...
  /// Parse from a json
  factory UserPrivacySettingAutosaveGifts.fromJson(Map<String, dynamic> json) => const UserPrivacySettingAutosaveGifts();
  ...
  @override
  UserPrivacySettingAutosaveGifts copyWith() => const UserPrivacySettingAutosaveGifts();
...
class UserPrivacySettingAllowUnpaidMessages extends UserPrivacySetting {
  ...
  /// Parse from a json
  factory UserPrivacySettingAllowUnpaidMessages.fromJson(Map<String, dynamic> json) => const UserPrivacySettingAllowUnpaidMessages();
  ...
  @override
  UserPrivacySettingAllowUnpaidMessages copyWith() => const UserPrivacySettingAllowUnpaidMessages();
