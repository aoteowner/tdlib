...
class BotInfo extends TdObject {
  ...
  factory BotInfo.fromJson(Map<String, dynamic> json) => BotInfo(
    ...
    affiliateProgram: json['affiliate_program'] == null ? null : AffiliateProgramInfo.fromJson(json['affiliate_program']),
    ...
    verificationParameters: json['verification_parameters'] == null ? null : BotVerificationParameters.fromJson(json['verification_parameters']),
