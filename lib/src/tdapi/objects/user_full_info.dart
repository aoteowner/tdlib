...
class UserFullInfo extends TdObject {
  ...
  factory UserFullInfo.fromJson(Map<String, dynamic> json) => UserFullInfo(
    ...
    birthdate: json['birthdate'] == null ? null : Birthdate.fromJson(json['birthdate']),
    ...
    botVerification: json['bot_verification'] == null ? null : BotVerification.fromJson(json['bot_verification']),
