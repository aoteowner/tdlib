...
class FailedToAddMembers extends TdObject {
  ...
  factory FailedToAddMembers.fromJson(Map<String, dynamic> json) =>
      FailedToAddMembers(
        failedToAddMembers: json['failed_to_add_members'] == null
            ? <FailedToAddMember>[]
            : (json['failed_to_add_members'] as List)
                .map((e) => FailedToAddMember.fromJson(e ?? {}))
                .toList(),
        extra: json['@extra'],
  ...
  Map<String, dynamic> toJson([dynamic extra]) {
    return {
      ...
      "failed_to_add_members":
          failedToAddMembers.map((e) => e.toJson()).toList(),
    };
  }
