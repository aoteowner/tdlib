...
TdObject? convertToObject(String? query) {
  ...
  switch (newJson['@type']) {
    ...
    case 'authenticationCodeTypeSmsWord': return AuthenticationCodeTypeSmsWord.fromJson(newJson);
    case 'authenticationCodeTypeSmsPhrase': return AuthenticationCodeTypeSmsPhrase.fromJson(newJson);
    ...
    case 'emailAddressResetState': return EmailAddressResetState.fromJson(newJson);
    ...
    case 'authorizationStateWaitPremiumPurchase': return AuthorizationStateWaitPremiumPurchase.fromJson(newJson);
    ...
    case 'firebaseDeviceVerificationParameters': return FirebaseDeviceVerificationParameters.fromJson(newJson);
    case 'firebaseDeviceVerificationParametersSafetyNet': return FirebaseDeviceVerificationParametersSafetyNet.fromJson(newJson);
    case 'firebaseDeviceVerificationParametersPlayIntegrity': return FirebaseDeviceVerificationParametersPlayIntegrity.fromJson(newJson);
    ...
    case 'outline': return Outline.fromJson(newJson);
    ...
    case 'alternativeVideo': return AlternativeVideo.fromJson(newJson);
    ...
    case 'botVerificationParameters': return BotVerificationParameters.fromJson(newJson);
    case 'botVerification': return BotVerification.fromJson(newJson);
    case 'verificationStatus': return VerificationStatus.fromJson(newJson);
    case 'chatLocation': return ChatLocation.fromJson(newJson);
    case 'birthdate': return Birthdate.fromJson(newJson);
    case 'closeBirthdayUser': return CloseBirthdayUser.fromJson(newJson);
    case 'businessAwayMessageSchedule': return BusinessAwayMessageSchedule.fromJson(newJson);
    case 'businessAwayMessageScheduleAlways': return BusinessAwayMessageScheduleAlways.fromJson(newJson);
    case 'businessAwayMessageScheduleOutsideOfOpeningHours': return BusinessAwayMessageScheduleOutsideOfOpeningHours.fromJson(newJson);
    case 'businessAwayMessageScheduleCustom': return BusinessAwayMessageScheduleCustom.fromJson(newJson);
    case 'businessLocation': return BusinessLocation.fromJson(newJson);
    case 'businessRecipients': return BusinessRecipients.fromJson(newJson);
    case 'businessAwayMessageSettings': return BusinessAwayMessageSettings.fromJson(newJson);
    case 'businessGreetingMessageSettings': return BusinessGreetingMessageSettings.fromJson(newJson);
    case 'businessBotRights': return BusinessBotRights.fromJson(newJson);
    case 'businessConnectedBot': return BusinessConnectedBot.fromJson(newJson);
    case 'businessStartPage': return BusinessStartPage.fromJson(newJson);
    case 'inputBusinessStartPage': return InputBusinessStartPage.fromJson(newJson);
    case 'businessOpeningHoursInterval': return BusinessOpeningHoursInterval.fromJson(newJson);
    case 'businessOpeningHours': return BusinessOpeningHours.fromJson(newJson);
    case 'businessInfo': return BusinessInfo.fromJson(newJson);
    case 'businessChatLink': return BusinessChatLink.fromJson(newJson);
    case 'businessChatLinks': return BusinessChatLinks.fromJson(newJson);
    case 'inputBusinessChatLink': return InputBusinessChatLink.fromJson(newJson);
    case 'businessChatLinkInfo': return BusinessChatLinkInfo.fromJson(newJson);
    case 'chatPhotoStickerType': return ChatPhotoStickerType.fromJson(newJson);
    ...
    case 'starAmount': return StarAmount.fromJson(newJson);
    case 'starSubscriptionType': return StarSubscriptionType.fromJson(newJson);
    case 'starSubscriptionTypeChannel': return StarSubscriptionTypeChannel.fromJson(newJson);
    case 'starSubscriptionTypeBot': return StarSubscriptionTypeBot.fromJson(newJson);
    case 'starSubscriptionPricing': return StarSubscriptionPricing.fromJson(newJson);
    case 'starSubscription': return StarSubscription.fromJson(newJson);
    case 'starSubscriptions': return StarSubscriptions.fromJson(newJson);
    case 'affiliateType': return AffiliateType.fromJson(newJson);
    case 'affiliateTypeCurrentUser': return AffiliateTypeCurrentUser.fromJson(newJson);
    case 'affiliateTypeBot': return AffiliateTypeBot.fromJson(newJson);
    case 'affiliateTypeChannel': return AffiliateTypeChannel.fromJson(newJson);
    case 'affiliateProgramSortOrder': return AffiliateProgramSortOrder.fromJson(newJson);
    case 'affiliateProgramSortOrderProfitability': return AffiliateProgramSortOrderProfitability.fromJson(newJson);
    case 'affiliateProgramSortOrderCreationDate': return AffiliateProgramSortOrderCreationDate.fromJson(newJson);
    case 'affiliateProgramSortOrderRevenue': return AffiliateProgramSortOrderRevenue.fromJson(newJson);
    case 'affiliateProgramParameters': return AffiliateProgramParameters.fromJson(newJson);
    case 'affiliateProgramInfo': return AffiliateProgramInfo.fromJson(newJson);
    case 'affiliateInfo': return AffiliateInfo.fromJson(newJson);
    case 'foundAffiliateProgram': return FoundAffiliateProgram.fromJson(newJson);
    case 'foundAffiliatePrograms': return FoundAffiliatePrograms.fromJson(newJson);
    case 'connectedAffiliateProgram': return ConnectedAffiliateProgram.fromJson(newJson);
    case 'connectedAffiliatePrograms': return ConnectedAffiliatePrograms.fromJson(newJson);
    case 'productInfo': return ProductInfo.fromJson(newJson);
    ...
    case 'premiumGiftPaymentOption': return PremiumGiftPaymentOption.fromJson(newJson);
    case 'premiumGiftPaymentOptions': return PremiumGiftPaymentOptions.fromJson(newJson);
    case 'premiumGiveawayPaymentOption': return PremiumGiveawayPaymentOption.fromJson(newJson);
    case 'premiumGiveawayPaymentOptions': return PremiumGiveawayPaymentOptions.fromJson(newJson);
    case 'premiumGiftCodeInfo': return PremiumGiftCodeInfo.fromJson(newJson);
    case 'starPaymentOption': return StarPaymentOption.fromJson(newJson);
    case 'starPaymentOptions': return StarPaymentOptions.fromJson(newJson);
    case 'starGiveawayWinnerOption': return StarGiveawayWinnerOption.fromJson(newJson);
    case 'starGiveawayPaymentOption': return StarGiveawayPaymentOption.fromJson(newJson);
    case 'starGiveawayPaymentOptions': return StarGiveawayPaymentOptions.fromJson(newJson);
    case 'acceptedGiftTypes': return AcceptedGiftTypes.fromJson(newJson);
    case 'giftSettings': return GiftSettings.fromJson(newJson);
    case 'upgradedGiftModel': return UpgradedGiftModel.fromJson(newJson);
    case 'upgradedGiftSymbol': return UpgradedGiftSymbol.fromJson(newJson);
    case 'upgradedGiftBackdropColors': return UpgradedGiftBackdropColors.fromJson(newJson);
    case 'upgradedGiftBackdrop': return UpgradedGiftBackdrop.fromJson(newJson);
    case 'upgradedGiftOriginalDetails': return UpgradedGiftOriginalDetails.fromJson(newJson);
    case 'gift': return Gift.fromJson(newJson);
    case 'upgradedGift': return UpgradedGift.fromJson(newJson);
    case 'upgradeGiftResult': return UpgradeGiftResult.fromJson(newJson);
    case 'availableGift': return AvailableGift.fromJson(newJson);
    case 'availableGifts': return AvailableGifts.fromJson(newJson);
    case 'upgradedGiftAttributeId': return UpgradedGiftAttributeId.fromJson(newJson);
    case 'upgradedGiftAttributeIdModel': return UpgradedGiftAttributeIdModel.fromJson(newJson);
    case 'upgradedGiftAttributeIdSymbol': return UpgradedGiftAttributeIdSymbol.fromJson(newJson);
    case 'upgradedGiftAttributeIdBackdrop': return UpgradedGiftAttributeIdBackdrop.fromJson(newJson);
    case 'upgradedGiftModelCount': return UpgradedGiftModelCount.fromJson(newJson);
    case 'upgradedGiftSymbolCount': return UpgradedGiftSymbolCount.fromJson(newJson);
    case 'upgradedGiftBackdropCount': return UpgradedGiftBackdropCount.fromJson(newJson);
    case 'giftForResaleOrder': return GiftForResaleOrder.fromJson(newJson);
    case 'giftForResaleOrderPrice': return GiftForResaleOrderPrice.fromJson(newJson);
    case 'giftForResaleOrderPriceChangeDate': return GiftForResaleOrderPriceChangeDate.fromJson(newJson);
    case 'giftForResaleOrderNumber': return GiftForResaleOrderNumber.fromJson(newJson);
    case 'giftForResale': return GiftForResale.fromJson(newJson);
    case 'giftsForResale': return GiftsForResale.fromJson(newJson);
    case 'sentGift': return SentGift.fromJson(newJson);
    case 'sentGiftRegular': return SentGiftRegular.fromJson(newJson);
    case 'sentGiftUpgraded': return SentGiftUpgraded.fromJson(newJson);
    case 'receivedGift': return ReceivedGift.fromJson(newJson);
    case 'receivedGifts': return ReceivedGifts.fromJson(newJson);
    case 'giftUpgradePreview': return GiftUpgradePreview.fromJson(newJson);
    case 'starTransactionDirection': return StarTransactionDirection.fromJson(newJson);
    case 'starTransactionDirectionIncoming': return StarTransactionDirectionIncoming.fromJson(newJson);
    case 'starTransactionDirectionOutgoing': return StarTransactionDirectionOutgoing.fromJson(newJson);
    case 'starTransactionType': return StarTransactionType.fromJson(newJson);
    case 'starTransactionTypePremiumBotDeposit': return StarTransactionTypePremiumBotDeposit.fromJson(newJson);
    case 'starTransactionTypeAppStoreDeposit': return StarTransactionTypeAppStoreDeposit.fromJson(newJson);
    case 'starTransactionTypeGooglePlayDeposit': return StarTransactionTypeGooglePlayDeposit.fromJson(newJson);
    case 'starTransactionTypeFragmentDeposit': return StarTransactionTypeFragmentDeposit.fromJson(newJson);
    case 'starTransactionTypeUserDeposit': return StarTransactionTypeUserDeposit.fromJson(newJson);
    case 'starTransactionTypeGiveawayDeposit': return StarTransactionTypeGiveawayDeposit.fromJson(newJson);
    case 'starTransactionTypeFragmentWithdrawal': return StarTransactionTypeFragmentWithdrawal.fromJson(newJson);
    case 'starTransactionTypeTelegramAdsWithdrawal': return StarTransactionTypeTelegramAdsWithdrawal.fromJson(newJson);
    case 'starTransactionTypeTelegramApiUsage': return StarTransactionTypeTelegramApiUsage.fromJson(newJson);
    case 'starTransactionTypeBotPaidMediaPurchase': return StarTransactionTypeBotPaidMediaPurchase.fromJson(newJson);
    case 'starTransactionTypeBotPaidMediaSale': return StarTransactionTypeBotPaidMediaSale.fromJson(newJson);
    case 'starTransactionTypeChannelPaidMediaPurchase': return StarTransactionTypeChannelPaidMediaPurchase.fromJson(newJson);
    case 'starTransactionTypeChannelPaidMediaSale': return StarTransactionTypeChannelPaidMediaSale.fromJson(newJson);
    case 'starTransactionTypeBotInvoicePurchase': return StarTransactionTypeBotInvoicePurchase.fromJson(newJson);
    case 'starTransactionTypeBotInvoiceSale': return StarTransactionTypeBotInvoiceSale.fromJson(newJson);
    case 'starTransactionTypeBotSubscriptionPurchase': return StarTransactionTypeBotSubscriptionPurchase.fromJson(newJson);
    case 'starTransactionTypeBotSubscriptionSale': return StarTransactionTypeBotSubscriptionSale.fromJson(newJson);
    case 'starTransactionTypeChannelSubscriptionPurchase': return StarTransactionTypeChannelSubscriptionPurchase.fromJson(newJson);
    case 'starTransactionTypeChannelSubscriptionSale': return StarTransactionTypeChannelSubscriptionSale.fromJson(newJson);
    case 'starTransactionTypeGiftPurchase': return StarTransactionTypeGiftPurchase.fromJson(newJson);
    case 'starTransactionTypeGiftTransfer': return StarTransactionTypeGiftTransfer.fromJson(newJson);
    case 'starTransactionTypeGiftSale': return StarTransactionTypeGiftSale.fromJson(newJson);
    case 'starTransactionTypeGiftUpgrade': return StarTransactionTypeGiftUpgrade.fromJson(newJson);
    case 'starTransactionTypeUpgradedGiftPurchase': return StarTransactionTypeUpgradedGiftPurchase.fromJson(newJson);
    case 'starTransactionTypeUpgradedGiftSale': return StarTransactionTypeUpgradedGiftSale.fromJson(newJson);
    case 'starTransactionTypeChannelPaidReactionSend': return StarTransactionTypeChannelPaidReactionSend.fromJson(newJson);
    case 'starTransactionTypeChannelPaidReactionReceive': return StarTransactionTypeChannelPaidReactionReceive.fromJson(newJson);
    case 'starTransactionTypeAffiliateProgramCommission': return StarTransactionTypeAffiliateProgramCommission.fromJson(newJson);
    case 'starTransactionTypePaidMessageSend': return StarTransactionTypePaidMessageSend.fromJson(newJson);
    case 'starTransactionTypePaidMessageReceive': return StarTransactionTypePaidMessageReceive.fromJson(newJson);
    case 'starTransactionTypePremiumPurchase': return StarTransactionTypePremiumPurchase.fromJson(newJson);
    case 'starTransactionTypeBusinessBotTransferSend': return StarTransactionTypeBusinessBotTransferSend.fromJson(newJson);
    case 'starTransactionTypeBusinessBotTransferReceive': return StarTransactionTypeBusinessBotTransferReceive.fromJson(newJson);
    case 'starTransactionTypeUnsupported': return StarTransactionTypeUnsupported.fromJson(newJson);
    case 'starTransaction': return StarTransaction.fromJson(newJson);
    case 'starTransactions': return StarTransactions.fromJson(newJson);
    case 'giveawayParticipantStatus': return GiveawayParticipantStatus.fromJson(newJson);
    case 'giveawayParticipantStatusEligible': return GiveawayParticipantStatusEligible.fromJson(newJson);
    case 'giveawayParticipantStatusParticipating': return GiveawayParticipantStatusParticipating.fromJson(newJson);
    case 'giveawayParticipantStatusAlreadyWasMember': return GiveawayParticipantStatusAlreadyWasMember.fromJson(newJson);
    case 'giveawayParticipantStatusAdministrator': return GiveawayParticipantStatusAdministrator.fromJson(newJson);
    case 'giveawayParticipantStatusDisallowedCountry': return GiveawayParticipantStatusDisallowedCountry.fromJson(newJson);
    case 'giveawayInfo': return GiveawayInfo.fromJson(newJson);
    case 'giveawayInfoOngoing': return GiveawayInfoOngoing.fromJson(newJson);
    case 'giveawayInfoCompleted': return GiveawayInfoCompleted.fromJson(newJson);
    case 'giveawayPrize': return GiveawayPrize.fromJson(newJson);
    case 'giveawayPrizePremium': return GiveawayPrizePremium.fromJson(newJson);
    case 'giveawayPrizeStars': return GiveawayPrizeStars.fromJson(newJson);
    case 'accentColor': return AccentColor.fromJson(newJson);
    case 'profileAccentColors': return ProfileAccentColors.fromJson(newJson);
    case 'profileAccentColor': return ProfileAccentColor.fromJson(newJson);
    case 'emojiStatusType': return EmojiStatusType.fromJson(newJson);
    case 'emojiStatusTypeCustomEmoji': return EmojiStatusTypeCustomEmoji.fromJson(newJson);
    case 'emojiStatusTypeUpgradedGift': return EmojiStatusTypeUpgradedGift.fromJson(newJson);
    case 'emojiStatus': return EmojiStatus.fromJson(newJson);
    case 'emojiStatuses': return EmojiStatuses.fromJson(newJson);
    case 'emojiStatusCustomEmojis': return EmojiStatusCustomEmojis.fromJson(newJson);
    ...
    case 'foundUsers': return FoundUsers.fromJson(newJson);
    ...
    case 'inviteLinkChatType': return InviteLinkChatType.fromJson(newJson);
    case 'inviteLinkChatTypeBasicGroup': return InviteLinkChatTypeBasicGroup.fromJson(newJson);
    case 'inviteLinkChatTypeSupergroup': return InviteLinkChatTypeSupergroup.fromJson(newJson);
    case 'inviteLinkChatTypeChannel': return InviteLinkChatTypeChannel.fromJson(newJson);
    case 'chatInviteLinkSubscriptionInfo': return ChatInviteLinkSubscriptionInfo.fromJson(newJson);
    ...
    case 'messageReadDate': return MessageReadDate.fromJson(newJson);
    case 'messageReadDateRead': return MessageReadDateRead.fromJson(newJson);
    case 'messageReadDateUnread': return MessageReadDateUnread.fromJson(newJson);
    case 'messageReadDateTooOld': return MessageReadDateTooOld.fromJson(newJson);
    case 'messageReadDateUserPrivacyRestricted': return MessageReadDateUserPrivacyRestricted.fromJson(newJson);
    case 'messageReadDateMyPrivacyRestricted': return MessageReadDateMyPrivacyRestricted.fromJson(newJson);
    case 'messageViewer': return MessageViewer.fromJson(newJson);
    case 'messageViewers': return MessageViewers.fromJson(newJson);
    case 'messageOrigin': return MessageOrigin.fromJson(newJson);
    case 'messageOriginUser': return MessageOriginUser.fromJson(newJson);
    case 'messageOriginHiddenUser': return MessageOriginHiddenUser.fromJson(newJson);
    case 'messageOriginChat': return MessageOriginChat.fromJson(newJson);
    case 'messageOriginChannel': return MessageOriginChannel.fromJson(newJson);
    case 'forwardSource': return ForwardSource.fromJson(newJson);
    ...
    case 'reactionTypePaid': return ReactionTypePaid.fromJson(newJson);
    case 'paidReactionType': return PaidReactionType.fromJson(newJson);
    case 'paidReactionTypeRegular': return PaidReactionTypeRegular.fromJson(newJson);
    case 'paidReactionTypeAnonymous': return PaidReactionTypeAnonymous.fromJson(newJson);
    case 'paidReactionTypeChat': return PaidReactionTypeChat.fromJson(newJson);
    case 'paidReactor': return PaidReactor.fromJson(newJson);
    case 'messageForwardInfo': return MessageForwardInfo.fromJson(newJson);
    case 'messageImportInfo': return MessageImportInfo.fromJson(newJson);
    ...
    case 'messageReactions': return MessageReactions.fromJson(newJson);
    ...
    case 'messageEffectType': return MessageEffectType.fromJson(newJson);
    case 'messageEffectTypeEmojiReaction': return MessageEffectTypeEmojiReaction.fromJson(newJson);
    case 'messageEffectTypePremiumSticker': return MessageEffectTypePremiumSticker.fromJson(newJson);
    case 'messageEffect': return MessageEffect.fromJson(newJson);
    ...
    case 'textQuote': return TextQuote.fromJson(newJson);
    case 'inputTextQuote': return InputTextQuote.fromJson(newJson);
    case 'messageReplyTo': return MessageReplyTo.fromJson(newJson);
    case 'messageReplyToMessage': return MessageReplyToMessage.fromJson(newJson);
    case 'messageReplyToStory': return MessageReplyToStory.fromJson(newJson);
    case 'inputMessageReplyTo': return InputMessageReplyTo.fromJson(newJson);
    case 'inputMessageReplyToMessage': return InputMessageReplyToMessage.fromJson(newJson);
    case 'inputMessageReplyToExternalMessage': return InputMessageReplyToExternalMessage.fromJson(newJson);
    case 'inputMessageReplyToStory': return InputMessageReplyToStory.fromJson(newJson);
    case 'factCheck': return FactCheck.fromJson(newJson);
    ...
    case 'businessMessage': return BusinessMessage.fromJson(newJson);
    case 'businessMessages': return BusinessMessages.fromJson(newJson);
    case 'messageSource': return MessageSource.fromJson(newJson);
    ...
    case 'messageSourceScreenshot': return MessageSourceScreenshot.fromJson(newJson);
    case 'messageSourceOther': return MessageSourceOther.fromJson(newJson);
    case 'messageSponsor': return MessageSponsor.fromJson(newJson);
    ...
    case 'sponsoredChat': return SponsoredChat.fromJson(newJson);
    case 'sponsoredChats': return SponsoredChats.fromJson(newJson);
    case 'reportOption': return ReportOption.fromJson(newJson);
    case 'reportSponsoredResult': return ReportSponsoredResult.fromJson(newJson);
    case 'reportSponsoredResultOk': return ReportSponsoredResultOk.fromJson(newJson);
    case 'reportSponsoredResultFailed': return ReportSponsoredResultFailed.fromJson(newJson);
    case 'reportSponsoredResultOptionRequired': return ReportSponsoredResultOptionRequired.fromJson(newJson);
    case 'reportSponsoredResultAdsHidden': return ReportSponsoredResultAdsHidden.fromJson(newJson);
    case 'reportSponsoredResultPremiumRequired': return ReportSponsoredResultPremiumRequired.fromJson(newJson);
    ...
    case 'reactionNotificationSource': return ReactionNotificationSource.fromJson(newJson);
    case 'reactionNotificationSourceNone': return ReactionNotificationSourceNone.fromJson(newJson);
    case 'reactionNotificationSourceContacts': return ReactionNotificationSourceContacts.fromJson(newJson);
    case 'reactionNotificationSourceAll': return ReactionNotificationSourceAll.fromJson(newJson);
    case 'reactionNotificationSettings': return ReactionNotificationSettings.fromJson(newJson);
    ...
    case 'chatFolderName': return ChatFolderName.fromJson(newJson);
    ...
    case 'archiveChatListSettings': return ArchiveChatListSettings.fromJson(newJson);
    ...
    case 'savedMessagesTag': return SavedMessagesTag.fromJson(newJson);
    case 'savedMessagesTags': return SavedMessagesTags.fromJson(newJson);
    case 'businessBotManageBar': return BusinessBotManageBar.fromJson(newJson);
    ...
    case 'failedToAddMember': return FailedToAddMember.fromJson(newJson);
    case 'failedToAddMembers': return FailedToAddMembers.fromJson(newJson);
    case 'createdBasicGroupChat': return CreatedBasicGroupChat.fromJson(newJson);
    ...
    case 'accountInfo': return AccountInfo.fromJson(newJson);
    ...
    case 'keyboardButtonTypeRequestUsers': return KeyboardButtonTypeRequestUsers.fromJson(newJson);
    ...
    case 'inlineKeyboardButtonTypeCopyText': return InlineKeyboardButtonTypeCopyText.fromJson(newJson);
    ...
    case 'webAppOpenMode': return WebAppOpenMode.fromJson(newJson);
    case 'webAppOpenModeCompact': return WebAppOpenModeCompact.fromJson(newJson);
    case 'webAppOpenModeFullSize': return WebAppOpenModeFullSize.fromJson(newJson);
    case 'webAppOpenModeFullScreen': return WebAppOpenModeFullScreen.fromJson(newJson);
    case 'foundWebApp': return FoundWebApp.fromJson(newJson);
    case 'webAppInfo': return WebAppInfo.fromJson(newJson);
    case 'mainWebApp': return MainWebApp.fromJson(newJson);
    case 'webAppOpenParameters': return WebAppOpenParameters.fromJson(newJson);
    case 'messageThreadInfo': return MessageThreadInfo.fromJson(newJson);
    case 'savedMessagesTopicType': return SavedMessagesTopicType.fromJson(newJson);
    case 'savedMessagesTopicTypeMyNotes': return SavedMessagesTopicTypeMyNotes.fromJson(newJson);
    case 'savedMessagesTopicTypeAuthorHidden': return SavedMessagesTopicTypeAuthorHidden.fromJson(newJson);
    case 'savedMessagesTopicTypeSavedFromChat': return SavedMessagesTopicTypeSavedFromChat.fromJson(newJson);
    case 'savedMessagesTopic': return SavedMessagesTopic.fromJson(newJson);
    ...
    case 'linkPreviewOptions': return LinkPreviewOptions.fromJson(newJson);
    case 'sharedUser': return SharedUser.fromJson(newJson);
    case 'sharedChat': return SharedChat.fromJson(newJson);
    ...
    case 'linkPreviewAlbumMedia': return LinkPreviewAlbumMedia.fromJson(newJson);
    case 'linkPreviewAlbumMediaPhoto': return LinkPreviewAlbumMediaPhoto.fromJson(newJson);
    case 'linkPreviewAlbumMediaVideo': return LinkPreviewAlbumMediaVideo.fromJson(newJson);
    case 'linkPreviewType': return LinkPreviewType.fromJson(newJson);
    case 'linkPreviewTypeAlbum': return LinkPreviewTypeAlbum.fromJson(newJson);
    case 'linkPreviewTypeAnimation': return LinkPreviewTypeAnimation.fromJson(newJson);
    case 'linkPreviewTypeApp': return LinkPreviewTypeApp.fromJson(newJson);
    case 'linkPreviewTypeArticle': return LinkPreviewTypeArticle.fromJson(newJson);
    case 'linkPreviewTypeAudio': return LinkPreviewTypeAudio.fromJson(newJson);
    case 'linkPreviewTypeBackground': return LinkPreviewTypeBackground.fromJson(newJson);
    case 'linkPreviewTypeChannelBoost': return LinkPreviewTypeChannelBoost.fromJson(newJson);
    case 'linkPreviewTypeChat': return LinkPreviewTypeChat.fromJson(newJson);
    case 'linkPreviewTypeDocument': return LinkPreviewTypeDocument.fromJson(newJson);
    case 'linkPreviewTypeEmbeddedAnimationPlayer': return LinkPreviewTypeEmbeddedAnimationPlayer.fromJson(newJson);
    case 'linkPreviewTypeEmbeddedAudioPlayer': return LinkPreviewTypeEmbeddedAudioPlayer.fromJson(newJson);
    case 'linkPreviewTypeEmbeddedVideoPlayer': return LinkPreviewTypeEmbeddedVideoPlayer.fromJson(newJson);
    case 'linkPreviewTypeExternalAudio': return LinkPreviewTypeExternalAudio.fromJson(newJson);
    case 'linkPreviewTypeExternalVideo': return LinkPreviewTypeExternalVideo.fromJson(newJson);
    case 'linkPreviewTypeGroupCall': return LinkPreviewTypeGroupCall.fromJson(newJson);
    case 'linkPreviewTypeInvoice': return LinkPreviewTypeInvoice.fromJson(newJson);
    case 'linkPreviewTypeMessage': return LinkPreviewTypeMessage.fromJson(newJson);
    case 'linkPreviewTypePhoto': return LinkPreviewTypePhoto.fromJson(newJson);
    case 'linkPreviewTypePremiumGiftCode': return LinkPreviewTypePremiumGiftCode.fromJson(newJson);
    case 'linkPreviewTypeShareableChatFolder': return LinkPreviewTypeShareableChatFolder.fromJson(newJson);
    case 'linkPreviewTypeSticker': return LinkPreviewTypeSticker.fromJson(newJson);
    case 'linkPreviewTypeStickerSet': return LinkPreviewTypeStickerSet.fromJson(newJson);
    case 'linkPreviewTypeStory': return LinkPreviewTypeStory.fromJson(newJson);
    case 'linkPreviewTypeSupergroupBoost': return LinkPreviewTypeSupergroupBoost.fromJson(newJson);
    case 'linkPreviewTypeTheme': return LinkPreviewTypeTheme.fromJson(newJson);
    case 'linkPreviewTypeUnsupported': return LinkPreviewTypeUnsupported.fromJson(newJson);
    case 'linkPreviewTypeUpgradedGift': return LinkPreviewTypeUpgradedGift.fromJson(newJson);
    case 'linkPreviewTypeUser': return LinkPreviewTypeUser.fromJson(newJson);
    case 'linkPreviewTypeVideo': return LinkPreviewTypeVideo.fromJson(newJson);
    case 'linkPreviewTypeVideoChat': return LinkPreviewTypeVideoChat.fromJson(newJson);
    case 'linkPreviewTypeVideoNote': return LinkPreviewTypeVideoNote.fromJson(newJson);
    case 'linkPreviewTypeVoiceNote': return LinkPreviewTypeVoiceNote.fromJson(newJson);
    case 'linkPreviewTypeWebApp': return LinkPreviewTypeWebApp.fromJson(newJson);
    case 'linkPreview': return LinkPreview.fromJson(newJson);
    ...
    case 'collectibleItemType': return CollectibleItemType.fromJson(newJson);
    case 'collectibleItemTypeUsername': return CollectibleItemTypeUsername.fromJson(newJson);
    case 'collectibleItemTypePhoneNumber': return CollectibleItemTypePhoneNumber.fromJson(newJson);
    case 'collectibleItemInfo': return CollectibleItemInfo.fromJson(newJson);
    ...
    case 'locationAddress': return LocationAddress.fromJson(newJson);
    ...
    case 'paymentFormType': return PaymentFormType.fromJson(newJson);
    case 'paymentFormTypeRegular': return PaymentFormTypeRegular.fromJson(newJson);
    case 'paymentFormTypeStars': return PaymentFormTypeStars.fromJson(newJson);
    case 'paymentFormTypeStarSubscription': return PaymentFormTypeStarSubscription.fromJson(newJson);
    ...
    case 'paymentReceiptType': return PaymentReceiptType.fromJson(newJson);
    case 'paymentReceiptTypeRegular': return PaymentReceiptTypeRegular.fromJson(newJson);
    case 'paymentReceiptTypeStars': return PaymentReceiptTypeStars.fromJson(newJson);
    ...
    case 'inputInvoiceTelegram': return InputInvoiceTelegram.fromJson(newJson);
    case 'paidMedia': return PaidMedia.fromJson(newJson);
    case 'paidMediaPreview': return PaidMediaPreview.fromJson(newJson);
    case 'paidMediaPhoto': return PaidMediaPhoto.fromJson(newJson);
    case 'paidMediaVideo': return PaidMediaVideo.fromJson(newJson);
    case 'paidMediaUnsupported': return PaidMediaUnsupported.fromJson(newJson);
    case 'giveawayParameters': return GiveawayParameters.fromJson(newJson);
    ...
    case 'messagePaidMedia': return MessagePaidMedia.fromJson(newJson);
    ...
    case 'messageExpiredVideoNote': return MessageExpiredVideoNote.fromJson(newJson);
    case 'messageExpiredVoiceNote': return MessageExpiredVoiceNote.fromJson(newJson);
    ...
    case 'messageStory': return MessageStory.fromJson(newJson);
    case 'messageInvoice': return MessageInvoice.fromJson(newJson);
    case 'messageCall': return MessageCall.fromJson(newJson);
    case 'messageGroupCall': return MessageGroupCall.fromJson(newJson);
    ...
    case 'messageChatBoost': return MessageChatBoost.fromJson(newJson);
    ...
    case 'messagePaymentRefunded': return MessagePaymentRefunded.fromJson(newJson);
    case 'messageGiftedPremium': return MessageGiftedPremium.fromJson(newJson);
    case 'messagePremiumGiftCode': return MessagePremiumGiftCode.fromJson(newJson);
    case 'messageGiveawayCreated': return MessageGiveawayCreated.fromJson(newJson);
    case 'messageGiveaway': return MessageGiveaway.fromJson(newJson);
    case 'messageGiveawayCompleted': return MessageGiveawayCompleted.fromJson(newJson);
    case 'messageGiveawayWinners': return MessageGiveawayWinners.fromJson(newJson);
    case 'messageGiftedStars': return MessageGiftedStars.fromJson(newJson);
    case 'messageGiveawayPrizeStars': return MessageGiveawayPrizeStars.fromJson(newJson);
    case 'messageGift': return MessageGift.fromJson(newJson);
    case 'messageUpgradedGift': return MessageUpgradedGift.fromJson(newJson);
    case 'messageRefundedUpgradedGift': return MessageRefundedUpgradedGift.fromJson(newJson);
    case 'messagePaidMessagesRefunded': return MessagePaidMessagesRefunded.fromJson(newJson);
    case 'messagePaidMessagePriceChanged': return MessagePaidMessagePriceChanged.fromJson(newJson);
    case 'messageContactRegistered': return MessageContactRegistered.fromJson(newJson);
    case 'messageUsersShared': return MessageUsersShared.fromJson(newJson);
    ...
    case 'textEntityTypeBlockQuote': return TextEntityTypeBlockQuote.fromJson(newJson);
    case 'textEntityTypeExpandableBlockQuote': return TextEntityTypeExpandableBlockQuote.fromJson(newJson);
    ...
    case 'inputPaidMediaType': return InputPaidMediaType.fromJson(newJson);
    case 'inputPaidMediaTypePhoto': return InputPaidMediaTypePhoto.fromJson(newJson);
    case 'inputPaidMediaTypeVideo': return InputPaidMediaTypeVideo.fromJson(newJson);
    case 'inputPaidMedia': return InputPaidMedia.fromJson(newJson);
    ...
    case 'messageSchedulingStateSendWhenVideoProcessed': return MessageSchedulingStateSendWhenVideoProcessed.fromJson(newJson);
    case 'messageSelfDestructType': return MessageSelfDestructType.fromJson(newJson);
    case 'messageSelfDestructTypeTimer': return MessageSelfDestructTypeTimer.fromJson(newJson);
    case 'messageSelfDestructTypeImmediately': return MessageSelfDestructTypeImmediately.fromJson(newJson);
    ...
    case 'inputMessagePaidMedia': return InputMessagePaidMedia.fromJson(newJson);
    ...
    case 'inputMessageStory': return InputMessageStory.fromJson(newJson);
    case 'inputMessageForwarded': return InputMessageForwarded.fromJson(newJson);
    case 'messageProperties': return MessageProperties.fromJson(newJson);
    ...
    case 'searchMessagesChatTypeFilter': return SearchMessagesChatTypeFilter.fromJson(newJson);
    case 'searchMessagesChatTypeFilterPrivate': return SearchMessagesChatTypeFilterPrivate.fromJson(newJson);
    case 'searchMessagesChatTypeFilterGroup': return SearchMessagesChatTypeFilterGroup.fromJson(newJson);
    case 'searchMessagesChatTypeFilterChannel': return SearchMessagesChatTypeFilterChannel.fromJson(newJson);
    ...
    case 'emojiKeyword': return EmojiKeyword.fromJson(newJson);
    case 'emojiKeywords': return EmojiKeywords.fromJson(newJson);
    ...
    case 'emojiCategorySource': return EmojiCategorySource.fromJson(newJson);
    case 'emojiCategorySourceSearch': return EmojiCategorySourceSearch.fromJson(newJson);
    case 'emojiCategorySourcePremium': return EmojiCategorySourcePremium.fromJson(newJson);
    case 'emojiCategory': return EmojiCategory.fromJson(newJson);
    case 'emojiCategories': return EmojiCategories.fromJson(newJson);
    case 'emojiCategoryType': return EmojiCategoryType.fromJson(newJson);
    case 'emojiCategoryTypeDefault': return EmojiCategoryTypeDefault.fromJson(newJson);
    case 'emojiCategoryTypeRegularStickers': return EmojiCategoryTypeRegularStickers.fromJson(newJson);
    ...
    case 'currentWeather': return CurrentWeather.fromJson(newJson);
    case 'storyAreaPosition': return StoryAreaPosition.fromJson(newJson);
    case 'storyAreaType': return StoryAreaType.fromJson(newJson);
    case 'storyAreaTypeLocation': return StoryAreaTypeLocation.fromJson(newJson);
    case 'storyAreaTypeVenue': return StoryAreaTypeVenue.fromJson(newJson);
    case 'storyAreaTypeSuggestedReaction': return StoryAreaTypeSuggestedReaction.fromJson(newJson);
    case 'storyAreaTypeMessage': return StoryAreaTypeMessage.fromJson(newJson);
    case 'storyAreaTypeLink': return StoryAreaTypeLink.fromJson(newJson);
    case 'storyAreaTypeWeather': return StoryAreaTypeWeather.fromJson(newJson);
    case 'storyAreaTypeUpgradedGift': return StoryAreaTypeUpgradedGift.fromJson(newJson);
    case 'storyArea': return StoryArea.fromJson(newJson);
    case 'inputStoryAreaType': return InputStoryAreaType.fromJson(newJson);
    case 'inputStoryAreaTypeLocation': return InputStoryAreaTypeLocation.fromJson(newJson);
    case 'inputStoryAreaTypeFoundVenue': return InputStoryAreaTypeFoundVenue.fromJson(newJson);
    case 'inputStoryAreaTypePreviousVenue': return InputStoryAreaTypePreviousVenue.fromJson(newJson);
    case 'inputStoryAreaTypeSuggestedReaction': return InputStoryAreaTypeSuggestedReaction.fromJson(newJson);
    case 'inputStoryAreaTypeMessage': return InputStoryAreaTypeMessage.fromJson(newJson);
    case 'inputStoryAreaTypeLink': return InputStoryAreaTypeLink.fromJson(newJson);
    case 'inputStoryAreaTypeWeather': return InputStoryAreaTypeWeather.fromJson(newJson);
    case 'inputStoryAreaTypeUpgradedGift': return InputStoryAreaTypeUpgradedGift.fromJson(newJson);
    case 'inputStoryArea': return InputStoryArea.fromJson(newJson);
    case 'inputStoryAreas': return InputStoryAreas.fromJson(newJson);
    case 'storyVideo': return StoryVideo.fromJson(newJson);
    case 'storyContent': return StoryContent.fromJson(newJson);
    case 'storyContentPhoto': return StoryContentPhoto.fromJson(newJson);
    case 'storyContentVideo': return StoryContentVideo.fromJson(newJson);
    case 'storyContentUnsupported': return StoryContentUnsupported.fromJson(newJson);
    case 'inputStoryContent': return InputStoryContent.fromJson(newJson);
    case 'inputStoryContentPhoto': return InputStoryContentPhoto.fromJson(newJson);
    case 'inputStoryContentVideo': return InputStoryContentVideo.fromJson(newJson);
    case 'storyList': return StoryList.fromJson(newJson);
    case 'storyListMain': return StoryListMain.fromJson(newJson);
    case 'storyListArchive': return StoryListArchive.fromJson(newJson);
    case 'storyOrigin': return StoryOrigin.fromJson(newJson);
    case 'storyOriginPublicStory': return StoryOriginPublicStory.fromJson(newJson);
    case 'storyOriginHiddenUser': return StoryOriginHiddenUser.fromJson(newJson);
    case 'storyRepostInfo': return StoryRepostInfo.fromJson(newJson);
    case 'storyInteractionInfo': return StoryInteractionInfo.fromJson(newJson);
    case 'story': return Story.fromJson(newJson);
    case 'stories': return Stories.fromJson(newJson);
    case 'foundStories': return FoundStories.fromJson(newJson);
    case 'storyFullId': return StoryFullId.fromJson(newJson);
    case 'storyInfo': return StoryInfo.fromJson(newJson);
    case 'chatActiveStories': return ChatActiveStories.fromJson(newJson);
    case 'storyInteractionType': return StoryInteractionType.fromJson(newJson);
    case 'storyInteractionTypeView': return StoryInteractionTypeView.fromJson(newJson);
    case 'storyInteractionTypeForward': return StoryInteractionTypeForward.fromJson(newJson);
    case 'storyInteractionTypeRepost': return StoryInteractionTypeRepost.fromJson(newJson);
    case 'storyInteraction': return StoryInteraction.fromJson(newJson);
    case 'storyInteractions': return StoryInteractions.fromJson(newJson);
    case 'quickReplyMessage': return QuickReplyMessage.fromJson(newJson);
    case 'quickReplyMessages': return QuickReplyMessages.fromJson(newJson);
    case 'quickReplyShortcut': return QuickReplyShortcut.fromJson(newJson);
    case 'publicForward': return PublicForward.fromJson(newJson);
    case 'publicForwardMessage': return PublicForwardMessage.fromJson(newJson);
    case 'publicForwardStory': return PublicForwardStory.fromJson(newJson);
    case 'publicForwards': return PublicForwards.fromJson(newJson);
    case 'botMediaPreview': return BotMediaPreview.fromJson(newJson);
    case 'botMediaPreviews': return BotMediaPreviews.fromJson(newJson);
    case 'botMediaPreviewInfo': return BotMediaPreviewInfo.fromJson(newJson);
    case 'chatBoostLevelFeatures': return ChatBoostLevelFeatures.fromJson(newJson);
    case 'chatBoostFeatures': return ChatBoostFeatures.fromJson(newJson);
    case 'chatBoostSource': return ChatBoostSource.fromJson(newJson);
    case 'chatBoostSourceGiftCode': return ChatBoostSourceGiftCode.fromJson(newJson);
    case 'chatBoostSourceGiveaway': return ChatBoostSourceGiveaway.fromJson(newJson);
    case 'chatBoostSourcePremium': return ChatBoostSourcePremium.fromJson(newJson);
    case 'prepaidGiveaway': return PrepaidGiveaway.fromJson(newJson);
    case 'chatBoostStatus': return ChatBoostStatus.fromJson(newJson);
    case 'chatBoost': return ChatBoost.fromJson(newJson);
    case 'foundChatBoosts': return FoundChatBoosts.fromJson(newJson);
    case 'chatBoostSlot': return ChatBoostSlot.fromJson(newJson);
    case 'chatBoostSlots': return ChatBoostSlots.fromJson(newJson);
    case 'resendCodeReason': return ResendCodeReason.fromJson(newJson);
    case 'resendCodeReasonUserRequest': return ResendCodeReasonUserRequest.fromJson(newJson);
    case 'resendCodeReasonVerificationFailed': return ResendCodeReasonVerificationFailed.fromJson(newJson);
    ...
    case 'callDiscardReasonUpgradeToGroupCall': return CallDiscardReasonUpgradeToGroupCall.fromJson(newJson);
    ...
    case 'groupCallJoinParameters': return GroupCallJoinParameters.fromJson(newJson);
    ...
    case 'videoChatStream': return VideoChatStream.fromJson(newJson);
    case 'videoChatStreams': return VideoChatStreams.fromJson(newJson);
    ...
    case 'groupCallParticipants': return GroupCallParticipants.fromJson(newJson);
    case 'groupCallInfo': return GroupCallInfo.fromJson(newJson);
    case 'inviteGroupCallParticipantResult': return InviteGroupCallParticipantResult.fromJson(newJson);
    case 'inviteGroupCallParticipantResultUserPrivacyRestricted': return InviteGroupCallParticipantResultUserPrivacyRestricted.fromJson(newJson);
    case 'inviteGroupCallParticipantResultUserAlreadyParticipant': return InviteGroupCallParticipantResultUserAlreadyParticipant.fromJson(newJson);
    case 'inviteGroupCallParticipantResultUserWasBanned': return InviteGroupCallParticipantResultUserWasBanned.fromJson(newJson);
    case 'inviteGroupCallParticipantResultSuccess': return InviteGroupCallParticipantResultSuccess.fromJson(newJson);
    case 'groupCallDataChannel': return GroupCallDataChannel.fromJson(newJson);
    case 'groupCallDataChannelMain': return GroupCallDataChannelMain.fromJson(newJson);
    case 'groupCallDataChannelScreenSharing': return GroupCallDataChannelScreenSharing.fromJson(newJson);
    case 'inputGroupCall': return InputGroupCall.fromJson(newJson);
    case 'inputGroupCallLink': return InputGroupCallLink.fromJson(newJson);
    case 'inputGroupCallMessage': return InputGroupCallMessage.fromJson(newJson);
    ...
    case 'firebaseAuthenticationSettings': return FirebaseAuthenticationSettings.fromJson(newJson);
    ...
    case 'reactionUnavailabilityReason': return ReactionUnavailabilityReason.fromJson(newJson);
    case 'reactionUnavailabilityReasonAnonymousAdministrator': return ReactionUnavailabilityReasonAnonymousAdministrator.fromJson(newJson);
    case 'reactionUnavailabilityReasonGuest': return ReactionUnavailabilityReasonGuest.fromJson(newJson);
    ...
    case 'businessConnection': return BusinessConnection.fromJson(newJson);
    ...
    case 'botWriteAccessAllowReason': return BotWriteAccessAllowReason.fromJson(newJson);
    case 'botWriteAccessAllowReasonConnectedWebsite': return BotWriteAccessAllowReasonConnectedWebsite.fromJson(newJson);
    case 'botWriteAccessAllowReasonAddedToAttachmentMenu': return BotWriteAccessAllowReasonAddedToAttachmentMenu.fromJson(newJson);
    case 'botWriteAccessAllowReasonLaunchedWebApp': return BotWriteAccessAllowReasonLaunchedWebApp.fromJson(newJson);
    case 'botWriteAccessAllowReasonAcceptedRequest': return BotWriteAccessAllowReasonAcceptedRequest.fromJson(newJson);
    case 'httpUrl': return HttpUrl.fromJson(newJson);
    case 'userLink': return UserLink.fromJson(newJson);
    case 'targetChatTypes': return TargetChatTypes.fromJson(newJson);
    ...
    case 'inlineQueryResultsButtonType': return InlineQueryResultsButtonType.fromJson(newJson);
    ...
    case 'preparedInlineMessageId': return PreparedInlineMessageId.fromJson(newJson);
    case 'preparedInlineMessage': return PreparedInlineMessage.fromJson(newJson);
    ...
    case 'chatEventMemberSubscriptionExtended': return ChatEventMemberSubscriptionExtended.fromJson(newJson);
    case 'chatEventAvailableReactionsChanged': return ChatEventAvailableReactionsChanged.fromJson(newJson);
    case 'chatEventBackgroundChanged': return ChatEventBackgroundChanged.fromJson(newJson);
    case 'chatEventDescriptionChanged': return ChatEventDescriptionChanged.fromJson(newJson);
    case 'chatEventEmojiStatusChanged': return ChatEventEmojiStatusChanged.fromJson(newJson);
    ...
    case 'chatEventCustomEmojiStickerSetChanged': return ChatEventCustomEmojiStickerSetChanged.fromJson(newJson);
    ...
    case 'chatEventAccentColorChanged': return ChatEventAccentColorChanged.fromJson(newJson);
    case 'chatEventProfileAccentColorChanged': return ChatEventProfileAccentColorChanged.fromJson(newJson);
    ...
    case 'chatEventShowMessageSenderToggled': return ChatEventShowMessageSenderToggled.fromJson(newJson);
    case 'chatEventAutomaticTranslationToggled': return ChatEventAutomaticTranslationToggled.fromJson(newJson);
    ...
    case 'premiumLimitTypePinnedSavedMessagesTopicCount': return PremiumLimitTypePinnedSavedMessagesTopicCount.fromJson(newJson);
    ...
    case 'premiumLimitTypeActiveStoryCount': return PremiumLimitTypeActiveStoryCount.fromJson(newJson);
    case 'premiumLimitTypeWeeklyPostedStoryCount': return PremiumLimitTypeWeeklyPostedStoryCount.fromJson(newJson);
    case 'premiumLimitTypeMonthlyPostedStoryCount': return PremiumLimitTypeMonthlyPostedStoryCount.fromJson(newJson);
    case 'premiumLimitTypeStoryCaptionLength': return PremiumLimitTypeStoryCaptionLength.fromJson(newJson);
    case 'premiumLimitTypeStorySuggestedReactionAreaCount': return PremiumLimitTypeStorySuggestedReactionAreaCount.fromJson(newJson);
    case 'premiumLimitTypeSimilarChatCount': return PremiumLimitTypeSimilarChatCount.fromJson(newJson);
    ...
    case 'premiumFeatureUpgradedStories': return PremiumFeatureUpgradedStories.fromJson(newJson);
    case 'premiumFeatureChatBoost': return PremiumFeatureChatBoost.fromJson(newJson);
    case 'premiumFeatureAccentColor': return PremiumFeatureAccentColor.fromJson(newJson);
    case 'premiumFeatureBackgroundForBoth': return PremiumFeatureBackgroundForBoth.fromJson(newJson);
    case 'premiumFeatureSavedMessagesTags': return PremiumFeatureSavedMessagesTags.fromJson(newJson);
    case 'premiumFeatureMessagePrivacy': return PremiumFeatureMessagePrivacy.fromJson(newJson);
    case 'premiumFeatureLastSeenTimes': return PremiumFeatureLastSeenTimes.fromJson(newJson);
    case 'premiumFeatureBusiness': return PremiumFeatureBusiness.fromJson(newJson);
    case 'premiumFeatureMessageEffects': return PremiumFeatureMessageEffects.fromJson(newJson);
    case 'businessFeature': return BusinessFeature.fromJson(newJson);
    case 'businessFeatureLocation': return BusinessFeatureLocation.fromJson(newJson);
    case 'businessFeatureOpeningHours': return BusinessFeatureOpeningHours.fromJson(newJson);
    case 'businessFeatureQuickReplies': return BusinessFeatureQuickReplies.fromJson(newJson);
    case 'businessFeatureGreetingMessage': return BusinessFeatureGreetingMessage.fromJson(newJson);
    case 'businessFeatureAwayMessage': return BusinessFeatureAwayMessage.fromJson(newJson);
    case 'businessFeatureAccountLinks': return BusinessFeatureAccountLinks.fromJson(newJson);
    case 'businessFeatureStartPage': return BusinessFeatureStartPage.fromJson(newJson);
    case 'businessFeatureBots': return BusinessFeatureBots.fromJson(newJson);
    case 'businessFeatureEmojiStatus': return BusinessFeatureEmojiStatus.fromJson(newJson);
    case 'businessFeatureChatFolderTags': return BusinessFeatureChatFolderTags.fromJson(newJson);
    case 'businessFeatureUpgradedStories': return BusinessFeatureUpgradedStories.fromJson(newJson);
    case 'premiumStoryFeature': return PremiumStoryFeature.fromJson(newJson);
    case 'premiumStoryFeaturePriorityOrder': return PremiumStoryFeaturePriorityOrder.fromJson(newJson);
    case 'premiumStoryFeatureStealthMode': return PremiumStoryFeatureStealthMode.fromJson(newJson);
    case 'premiumStoryFeaturePermanentViewsHistory': return PremiumStoryFeaturePermanentViewsHistory.fromJson(newJson);
    case 'premiumStoryFeatureCustomExpirationDuration': return PremiumStoryFeatureCustomExpirationDuration.fromJson(newJson);
    case 'premiumStoryFeatureSaveStories': return PremiumStoryFeatureSaveStories.fromJson(newJson);
    case 'premiumStoryFeatureLinksAndFormatting': return PremiumStoryFeatureLinksAndFormatting.fromJson(newJson);
    case 'premiumStoryFeatureVideoQuality': return PremiumStoryFeatureVideoQuality.fromJson(newJson);
    case 'premiumLimit': return PremiumLimit.fromJson(newJson);
    case 'premiumFeatures': return PremiumFeatures.fromJson(newJson);
    case 'businessFeatures': return BusinessFeatures.fromJson(newJson);
    ...
    case 'premiumSourceBusinessFeature': return PremiumSourceBusinessFeature.fromJson(newJson);
    case 'premiumSourceStoryFeature': return PremiumSourceStoryFeature.fromJson(newJson);
    ...
    case 'businessFeaturePromotionAnimation': return BusinessFeaturePromotionAnimation.fromJson(newJson);
    ...
    case 'storePaymentPurposePremiumGift': return StorePaymentPurposePremiumGift.fromJson(newJson);
    case 'storePaymentPurposePremiumGiftCodes': return StorePaymentPurposePremiumGiftCodes.fromJson(newJson);
    case 'storePaymentPurposePremiumGiveaway': return StorePaymentPurposePremiumGiveaway.fromJson(newJson);
    case 'storePaymentPurposeStarGiveaway': return StorePaymentPurposeStarGiveaway.fromJson(newJson);
    case 'storePaymentPurposeStars': return StorePaymentPurposeStars.fromJson(newJson);
    case 'storePaymentPurposeGiftedStars': return StorePaymentPurposeGiftedStars.fromJson(newJson);
    case 'storeTransaction': return StoreTransaction.fromJson(newJson);
    case 'storeTransactionAppStore': return StoreTransactionAppStore.fromJson(newJson);
    case 'storeTransactionGooglePlay': return StoreTransactionGooglePlay.fromJson(newJson);
    case 'telegramPaymentPurpose': return TelegramPaymentPurpose.fromJson(newJson);
    case 'telegramPaymentPurposePremiumGift': return TelegramPaymentPurposePremiumGift.fromJson(newJson);
    case 'telegramPaymentPurposePremiumGiftCodes': return TelegramPaymentPurposePremiumGiftCodes.fromJson(newJson);
    case 'telegramPaymentPurposePremiumGiveaway': return TelegramPaymentPurposePremiumGiveaway.fromJson(newJson);
    case 'telegramPaymentPurposeStars': return TelegramPaymentPurposeStars.fromJson(newJson);
    case 'telegramPaymentPurposeGiftedStars': return TelegramPaymentPurposeGiftedStars.fromJson(newJson);
    case 'telegramPaymentPurposeStarGiveaway': return TelegramPaymentPurposeStarGiveaway.fromJson(newJson);
    case 'telegramPaymentPurposeJoinChat': return TelegramPaymentPurposeJoinChat.fromJson(newJson);
    ...
    case 'backgroundTypeChatTheme': return BackgroundTypeChatTheme.fromJson(newJson);
    ...
    case 'timeZone': return TimeZone.fromJson(newJson);
    case 'timeZones': return TimeZones.fromJson(newJson);
    case 'hashtags': return Hashtags.fromJson(newJson);
    case 'canPostStoryResult': return CanPostStoryResult.fromJson(newJson);
    case 'canPostStoryResultOk': return CanPostStoryResultOk.fromJson(newJson);
    case 'canPostStoryResultPremiumNeeded': return CanPostStoryResultPremiumNeeded.fromJson(newJson);
    case 'canPostStoryResultBoostNeeded': return CanPostStoryResultBoostNeeded.fromJson(newJson);
    case 'canPostStoryResultActiveStoryLimitExceeded': return CanPostStoryResultActiveStoryLimitExceeded.fromJson(newJson);
    case 'canPostStoryResultWeeklyLimitExceeded': return CanPostStoryResultWeeklyLimitExceeded.fromJson(newJson);
    case 'canPostStoryResultMonthlyLimitExceeded': return CanPostStoryResultMonthlyLimitExceeded.fromJson(newJson);
    ...
    case 'pushMessageContentPaidMedia': return PushMessageContentPaidMedia.fromJson(newJson);
    ...
    case 'pushMessageContentPremiumGiftCode': return PushMessageContentPremiumGiftCode.fromJson(newJson);
    case 'pushMessageContentGiveaway': return PushMessageContentGiveaway.fromJson(newJson);
    case 'pushMessageContentGift': return PushMessageContentGift.fromJson(newJson);
    case 'pushMessageContentUpgradedGift': return PushMessageContentUpgradedGift.fromJson(newJson);
    ...
    case 'pushMessageContentStory': return PushMessageContentStory.fromJson(newJson);
    ...
    case 'pushMessageContentVideoChatStarted': return PushMessageContentVideoChatStarted.fromJson(newJson);
    case 'pushMessageContentVideoChatEnded': return PushMessageContentVideoChatEnded.fromJson(newJson);
    case 'pushMessageContentInviteVideoChatParticipants': return PushMessageContentInviteVideoChatParticipants.fromJson(newJson);
    ...
    case 'pushMessageContentProximityAlertTriggered': return PushMessageContentProximityAlertTriggered.fromJson(newJson);
    ...
    case 'storyPrivacySettings': return StoryPrivacySettings.fromJson(newJson);
    case 'storyPrivacySettingsEveryone': return StoryPrivacySettingsEveryone.fromJson(newJson);
    case 'storyPrivacySettingsContacts': return StoryPrivacySettingsContacts.fromJson(newJson);
    case 'storyPrivacySettingsCloseFriends': return StoryPrivacySettingsCloseFriends.fromJson(newJson);
    case 'storyPrivacySettingsSelectedUsers': return StoryPrivacySettingsSelectedUsers.fromJson(newJson);
    ...
    case 'userPrivacySettingRuleAllowBots': return UserPrivacySettingRuleAllowBots.fromJson(newJson);
    case 'userPrivacySettingRuleAllowPremiumUsers': return UserPrivacySettingRuleAllowPremiumUsers.fromJson(newJson);
    ...
    case 'userPrivacySettingRuleRestrictBots': return UserPrivacySettingRuleRestrictBots.fromJson(newJson);
    ...
    case 'userPrivacySettingShowBio': return UserPrivacySettingShowBio.fromJson(newJson);
    case 'userPrivacySettingShowBirthdate': return UserPrivacySettingShowBirthdate.fromJson(newJson);
    ...
    case 'userPrivacySettingAutosaveGifts': return UserPrivacySettingAutosaveGifts.fromJson(newJson);
    case 'userPrivacySettingAllowUnpaidMessages': return UserPrivacySettingAllowUnpaidMessages.fromJson(newJson);
    case 'readDatePrivacySettings': return ReadDatePrivacySettings.fromJson(newJson);
    case 'newChatPrivacySettings': return NewChatPrivacySettings.fromJson(newJson);
    case 'canSendMessageToUserResult': return CanSendMessageToUserResult.fromJson(newJson);
    case 'canSendMessageToUserResultOk': return CanSendMessageToUserResultOk.fromJson(newJson);
    case 'canSendMessageToUserResultUserHasPaidMessages': return CanSendMessageToUserResultUserHasPaidMessages.fromJson(newJson);
    case 'canSendMessageToUserResultUserIsDeleted': return CanSendMessageToUserResultUserIsDeleted.fromJson(newJson);
    case 'canSendMessageToUserResultUserRestrictsNewChats': return CanSendMessageToUserResultUserRestrictsNewChats.fromJson(newJson);
    ...
    case 'unconfirmedSession': return UnconfirmedSession.fromJson(newJson);
    ...
    case 'reportReason': return ReportReason.fromJson(newJson);
    case 'reportReasonSpam': return ReportReasonSpam.fromJson(newJson);
    case 'reportReasonViolence': return ReportReasonViolence.fromJson(newJson);
    case 'reportReasonPornography': return ReportReasonPornography.fromJson(newJson);
    case 'reportReasonChildAbuse': return ReportReasonChildAbuse.fromJson(newJson);
    case 'reportReasonCopyright': return ReportReasonCopyright.fromJson(newJson);
    case 'reportReasonUnrelatedLocation': return ReportReasonUnrelatedLocation.fromJson(newJson);
    case 'reportReasonFake': return ReportReasonFake.fromJson(newJson);
    case 'reportReasonIllegalDrugs': return ReportReasonIllegalDrugs.fromJson(newJson);
    case 'reportReasonPersonalDetails': return ReportReasonPersonalDetails.fromJson(newJson);
    case 'reportReasonCustom': return ReportReasonCustom.fromJson(newJson);
    case 'reportChatResult': return ReportChatResult.fromJson(newJson);
    case 'reportChatResultOk': return ReportChatResultOk.fromJson(newJson);
    case 'reportChatResultOptionRequired': return ReportChatResultOptionRequired.fromJson(newJson);
    case 'reportChatResultTextRequired': return ReportChatResultTextRequired.fromJson(newJson);
    case 'reportChatResultMessagesRequired': return ReportChatResultMessagesRequired.fromJson(newJson);
    case 'reportStoryResult': return ReportStoryResult.fromJson(newJson);
    case 'reportStoryResultOk': return ReportStoryResultOk.fromJson(newJson);
    case 'reportStoryResultOptionRequired': return ReportStoryResultOptionRequired.fromJson(newJson);
    case 'reportStoryResultTextRequired': return ReportStoryResultTextRequired.fromJson(newJson);
    ...
    case 'internalLinkTypeBusinessChat': return InternalLinkTypeBusinessChat.fromJson(newJson);
    case 'internalLinkTypeBuyStars': return InternalLinkTypeBuyStars.fromJson(newJson);
    case 'internalLinkTypeChangePhoneNumber': return InternalLinkTypeChangePhoneNumber.fromJson(newJson);
    case 'internalLinkTypeChatAffiliateProgram': return InternalLinkTypeChatAffiliateProgram.fromJson(newJson);
    case 'internalLinkTypeChatBoost': return InternalLinkTypeChatBoost.fromJson(newJson);
    ...
    case 'internalLinkTypeGroupCall': return InternalLinkTypeGroupCall.fromJson(newJson);
    ...
    case 'internalLinkTypeMainWebApp': return InternalLinkTypeMainWebApp.fromJson(newJson);
    ...
    case 'internalLinkTypeMyStars': return InternalLinkTypeMyStars.fromJson(newJson);
    ...
    case 'internalLinkTypePremiumGift': return InternalLinkTypePremiumGift.fromJson(newJson);
    case 'internalLinkTypePremiumGiftCode': return InternalLinkTypePremiumGiftCode.fromJson(newJson);
    ...
    case 'internalLinkTypeStory': return InternalLinkTypeStory.fromJson(newJson);
    ...
    case 'internalLinkTypeUpgradedGift': return InternalLinkTypeUpgradedGift.fromJson(newJson);
    ...
    case 'chatBoostLink': return ChatBoostLink.fromJson(newJson);
    case 'chatBoostLinkInfo': return ChatBoostLinkInfo.fromJson(newJson);
    case 'blockList': return BlockList.fromJson(newJson);
    case 'blockListMain': return BlockListMain.fromJson(newJson);
    case 'blockListStories': return BlockListStories.fromJson(newJson);
    ...
    case 'fileTypePhotoStory': return FileTypePhotoStory.fromJson(newJson);
    ...
    case 'fileTypeSelfDestructingPhoto': return FileTypeSelfDestructingPhoto.fromJson(newJson);
    case 'fileTypeSelfDestructingVideo': return FileTypeSelfDestructingVideo.fromJson(newJson);
    case 'fileTypeSelfDestructingVideoNote': return FileTypeSelfDestructingVideoNote.fromJson(newJson);
    case 'fileTypeSelfDestructingVoiceNote': return FileTypeSelfDestructingVoiceNote.fromJson(newJson);
    ...
    case 'fileTypeVideoStory': return FileTypeVideoStory.fromJson(newJson);
    ...
    case 'autosaveSettingsScope': return AutosaveSettingsScope.fromJson(newJson);
    ...
    case 'topChatCategoryWebAppBots': return TopChatCategoryWebAppBots.fromJson(newJson);
    ...
    case 'foundPosition': return FoundPosition.fromJson(newJson);
    case 'foundPositions': return FoundPositions.fromJson(newJson);
    ...
    case 'suggestedActionRestorePremium': return SuggestedActionRestorePremium.fromJson(newJson);
    case 'suggestedActionSubscribeToAnnualPremium': return SuggestedActionSubscribeToAnnualPremium.fromJson(newJson);
    case 'suggestedActionGiftPremiumForChristmas': return SuggestedActionGiftPremiumForChristmas.fromJson(newJson);
    case 'suggestedActionSetBirthdate': return SuggestedActionSetBirthdate.fromJson(newJson);
    case 'suggestedActionSetProfilePhoto': return SuggestedActionSetProfilePhoto.fromJson(newJson);
    case 'suggestedActionExtendPremium': return SuggestedActionExtendPremium.fromJson(newJson);
    case 'suggestedActionExtendStarSubscriptions': return SuggestedActionExtendStarSubscriptions.fromJson(newJson);
    case 'suggestedActionCustom': return SuggestedActionCustom.fromJson(newJson);
    case 'count': return Count.fromJson(newJson);
    case 'text': return Text.fromJson(newJson);
    case 'data': return Data.fromJson(newJson);
    ...
    case 'starCount': return StarCount.fromJson(newJson);
    ...
    case 'chatStatisticsObjectType': return ChatStatisticsObjectType.fromJson(newJson);
    case 'chatStatisticsObjectTypeMessage': return ChatStatisticsObjectTypeMessage.fromJson(newJson);
    case 'chatStatisticsObjectTypeStory': return ChatStatisticsObjectTypeStory.fromJson(newJson);
    case 'chatStatisticsInteractionInfo': return ChatStatisticsInteractionInfo.fromJson(newJson);
    ...
    case 'chatRevenueAmount': return ChatRevenueAmount.fromJson(newJson);
    case 'chatRevenueStatistics': return ChatRevenueStatistics.fromJson(newJson);
    case 'messageStatistics': return MessageStatistics.fromJson(newJson);
    case 'storyStatistics': return StoryStatistics.fromJson(newJson);
    case 'revenueWithdrawalState': return RevenueWithdrawalState.fromJson(newJson);
    case 'revenueWithdrawalStatePending': return RevenueWithdrawalStatePending.fromJson(newJson);
    case 'revenueWithdrawalStateSucceeded': return RevenueWithdrawalStateSucceeded.fromJson(newJson);
    case 'revenueWithdrawalStateFailed': return RevenueWithdrawalStateFailed.fromJson(newJson);
    case 'chatRevenueTransactionType': return ChatRevenueTransactionType.fromJson(newJson);
    case 'chatRevenueTransactionTypeEarnings': return ChatRevenueTransactionTypeEarnings.fromJson(newJson);
    case 'chatRevenueTransactionTypeWithdrawal': return ChatRevenueTransactionTypeWithdrawal.fromJson(newJson);
    case 'chatRevenueTransactionTypeRefund': return ChatRevenueTransactionTypeRefund.fromJson(newJson);
    case 'chatRevenueTransaction': return ChatRevenueTransaction.fromJson(newJson);
    case 'chatRevenueTransactions': return ChatRevenueTransactions.fromJson(newJson);
    case 'starRevenueStatus': return StarRevenueStatus.fromJson(newJson);
    case 'starRevenueStatistics': return StarRevenueStatistics.fromJson(newJson);
    ...
    case 'phoneNumberCodeType': return PhoneNumberCodeType.fromJson(newJson);
    case 'phoneNumberCodeTypeChange': return PhoneNumberCodeTypeChange.fromJson(newJson);
    case 'phoneNumberCodeTypeVerify': return PhoneNumberCodeTypeVerify.fromJson(newJson);
    case 'phoneNumberCodeTypeConfirmOwnership': return PhoneNumberCodeTypeConfirmOwnership.fromJson(newJson);
    ...
    case 'updateMessageFactCheck': return UpdateMessageFactCheck.fromJson(newJson);
    case 'updateMessageLiveLocationViewed': return UpdateMessageLiveLocationViewed.fromJson(newJson);
    case 'updateVideoPublished': return UpdateVideoPublished.fromJson(newJson);
    ...
    case 'updateChatAccentColors': return UpdateChatAccentColors.fromJson(newJson);
    ...
    case 'updateChatAddedToList': return UpdateChatAddedToList.fromJson(newJson);
    case 'updateChatRemovedFromList': return UpdateChatRemovedFromList.fromJson(newJson);
    ...
    case 'updateChatBusinessBotManageBar': return UpdateChatBusinessBotManageBar.fromJson(newJson);
    ...
    case 'updateChatEmojiStatus': return UpdateChatEmojiStatus.fromJson(newJson);
    ...
    case 'updateChatViewAsTopics': return UpdateChatViewAsTopics.fromJson(newJson);
    case 'updateChatBlockList': return UpdateChatBlockList.fromJson(newJson);
    ...
    case 'updateSavedMessagesTopic': return UpdateSavedMessagesTopic.fromJson(newJson);
    case 'updateSavedMessagesTopicCount': return UpdateSavedMessagesTopicCount.fromJson(newJson);
    case 'updateQuickReplyShortcut': return UpdateQuickReplyShortcut.fromJson(newJson);
    case 'updateQuickReplyShortcutDeleted': return UpdateQuickReplyShortcutDeleted.fromJson(newJson);
    case 'updateQuickReplyShortcuts': return UpdateQuickReplyShortcuts.fromJson(newJson);
    case 'updateQuickReplyShortcutMessages': return UpdateQuickReplyShortcutMessages.fromJson(newJson);
    case 'updateForumTopicInfo': return UpdateForumTopicInfo.fromJson(newJson);
    case 'updateForumTopic': return UpdateForumTopic.fromJson(newJson);
    case 'updateScopeNotificationSettings': return UpdateScopeNotificationSettings.fromJson(newJson);
    case 'updateReactionNotificationSettings': return UpdateReactionNotificationSettings.fromJson(newJson);
    ...
    case 'updateApplicationVerificationRequired': return UpdateApplicationVerificationRequired.fromJson(newJson);
    case 'updateApplicationRecaptchaVerificationRequired': return UpdateApplicationRecaptchaVerificationRequired.fromJson(newJson);
    ...
    case 'updateGroupCallParticipants': return UpdateGroupCallParticipants.fromJson(newJson);
    case 'updateGroupCallVerificationState': return UpdateGroupCallVerificationState.fromJson(newJson);
    ...
    case 'updateStory': return UpdateStory.fromJson(newJson);
    case 'updateStoryDeleted': return UpdateStoryDeleted.fromJson(newJson);
    case 'updateStoryPostSucceeded': return UpdateStoryPostSucceeded.fromJson(newJson);
    case 'updateStoryPostFailed': return UpdateStoryPostFailed.fromJson(newJson);
    case 'updateChatActiveStories': return UpdateChatActiveStories.fromJson(newJson);
    case 'updateStoryListChatCount': return UpdateStoryListChatCount.fromJson(newJson);
    case 'updateStoryStealthMode': return UpdateStoryStealthMode.fromJson(newJson);
    ...
    case 'updateDefaultBackground': return UpdateDefaultBackground.fromJson(newJson);
    case 'updateChatThemes': return UpdateChatThemes.fromJson(newJson);
    case 'updateAccentColors': return UpdateAccentColors.fromJson(newJson);
    case 'updateProfileAccentColors': return UpdateProfileAccentColors.fromJson(newJson);
    ...
    case 'updateFreezeState': return UpdateFreezeState.fromJson(newJson);
    case 'updateTermsOfService': return UpdateTermsOfService.fromJson(newJson);
    case 'updateUnconfirmedSession': return UpdateUnconfirmedSession.fromJson(newJson);
    ...
    case 'updateAvailableMessageEffects': return UpdateAvailableMessageEffects.fromJson(newJson);
    case 'updateDefaultReactionType': return UpdateDefaultReactionType.fromJson(newJson);
    case 'updateDefaultPaidReactionType': return UpdateDefaultPaidReactionType.fromJson(newJson);
    case 'updateSavedMessagesTags': return UpdateSavedMessagesTags.fromJson(newJson);
    case 'updateActiveLiveLocationMessages': return UpdateActiveLiveLocationMessages.fromJson(newJson);
    case 'updateOwnedStarCount': return UpdateOwnedStarCount.fromJson(newJson);
    case 'updateChatRevenueAmount': return UpdateChatRevenueAmount.fromJson(newJson);
    case 'updateStarRevenueStatus': return UpdateStarRevenueStatus.fromJson(newJson);
    case 'updateSpeechRecognitionTrial': return UpdateSpeechRecognitionTrial.fromJson(newJson);
    ...
    case 'updateSpeedLimitNotification': return UpdateSpeedLimitNotification.fromJson(newJson);
    case 'updateContactCloseBirthdays': return UpdateContactCloseBirthdays.fromJson(newJson);
    case 'updateAutosaveSettings': return UpdateAutosaveSettings.fromJson(newJson);
    case 'updateBusinessConnection': return UpdateBusinessConnection.fromJson(newJson);
    case 'updateNewBusinessMessage': return UpdateNewBusinessMessage.fromJson(newJson);
    case 'updateBusinessMessageEdited': return UpdateBusinessMessageEdited.fromJson(newJson);
    case 'updateBusinessMessagesDeleted': return UpdateBusinessMessagesDeleted.fromJson(newJson);
    ...
    case 'updateNewBusinessCallbackQuery': return UpdateNewBusinessCallbackQuery.fromJson(newJson);
    ...
    case 'updateChatBoost': return UpdateChatBoost.fromJson(newJson);
    case 'updateMessageReaction': return UpdateMessageReaction.fromJson(newJson);
    case 'updateMessageReactions': return UpdateMessageReactions.fromJson(newJson);
    case 'updatePaidMediaPurchased': return UpdatePaidMediaPurchased.fromJson(newJson);
