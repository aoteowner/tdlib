...
class TdNativePlugin extends TdPlugin {
  ...
  Future<RemoteController> toReceiveAsync(
    ...
    final isolate = await Isolate.spawn(IsolateController._run, raw.sendPort);
  ...
  Future<RemoteController> toReceiveJsonAsync(
    ...
    final isolate = await Isolate.spawn(
        IsolateController._runJson, (raw.sendPort, clientId));
    return IsolateController(isolate);
  }
}
...
class IsolateController extends RemoteController {
  ...
  static void _run(SendPort send) {
    final td = TdNativePlugin();
    Timer? timer;
  ...
  static void _runJson((SendPort, int) args) {
    final (send, clientId) = args;
